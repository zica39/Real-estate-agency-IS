      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul id="top-menu" class="nav navbar-nav navbar-right aa-main-nav">
			...
			<li class="active"><a href="my_properties.php">MOJE NEKRETNINE</a></li>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="aa-property-header-inner">
            ...
            <li class="active">MOJE NEKRETNINE</li>
          </ol>
          </div>
        </div>
      </div>
        ...
        <div class="col-md-4">
          <aside class="aa-properties-sidebar">
			<div class="aa-properties-single-sidebar">
			  ...
			  <form action='properties-add.php'>
			  <div class="aa-single-advance-search">
                  <input type="submit" value="Dodaj oglas" class="aa-search-btn">
                </div>
			   </form>
			</div> 
