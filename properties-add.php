<?php
	...
	if(!is_array($user))header('Location:./signin.php');
...
if(isset($_POST['submit'])){
	...
	$status =  mysqli_fetch_assoc(mysqli_query($db_conn,"select id from status_nekretnine WHERE naziv = 'dostupno'"))['id'];
	$korisnik_id = $user['id'];
	...
	$photos = json_encode($fotografije);
		
		if($photos){
			mysqli_query($db_conn,"UPDATE nekretnina SET fotografije = '$photos' WHERE id = $new_id");
		}
		
		header("Location:./properties-detail.php?id=$new_id");
	}
}
			...
			<div class="container1">
				<div class="aa-title">
				  ...
				  <div class="row">
					...
					<div class="col-75">
					  <select id="tip_oglasa" name="tip_oglasa" required>
					   <option selected="" value="" hidden>--Odaberi tip oglasa--</option>
						<?php 
				  ...
				  <div class="row">
					...
					<div class="col-75">
						<input type="number" id="cijena" name="cijena" value="" size="30" required="required">
					</div>
				  </div>
				  ...
				  <div class="row">
					...
					<div class="col-75">
						<input type="number" id="povrsina" name="povrsina" value="" size="30" required="required">
					</div>
				  </div>
				  ...
				  <div class="row">
					...
					<div class="col-75">
						 <input type="tel" id="telefon" name="telefon" value="" placeholder = '+3826XXXXXX'  >
					</div>
				  </div>
				  ...
				  <div class="row">
					...
					<div class="col-75">
						 <input type="text" id="adresa" name="adresa" value="" size="20" >
					</div>
				  </div>
				   ...
				   <div class="row">
					...
					<div class="col-75">
					  ...
					  <input type="hidden" name="svojstva" value="">
					</div>
				  </div>
				  ...
				  <div class="row">
					...
					<div class="col-75">
					  <textarea id="opis" name="opis" placeholder="Opisite nekretninu.." style="height:200px"></textarea>
					</div>
				  </div>
